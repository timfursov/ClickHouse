...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(BCRYPT_HASH, "BCRYPT_HASH") /*Underscore is intentional*/ \
    MR_MACROS(BCRYPT_PASSWORD, "BCRYPT_PASSWORD") /*Underscore is intentional*/ \
    ...
    MR_MACROS(CHANGEABLE_IN_READONLY, "CHANGEABLE_IN_READONLY") /*Underscore is intentional*/ \
    ...
    MR_MACROS(CREATE_PROFILE, "CREATE PROFILEMAX") \
    ...
    MR_MACROS(CURRENT_USER_ONEWORD, "CURRENTUSER") \
    MR_MACROS(CURRENT_USER, "CURRENT_USER") /*Underscore is intentional*/ \
    MR_MACROS(D, "D") \
    ...
    MR_MACROS(DIV, "DIV") \
    MR_MACROS(DOUBLE_SHA1_HASH, "DOUBLE_SHA1_HASH") /*Underscore is intentional*/ \
    MR_MACROS(DOUBLE_SHA1_PASSWORD, "DOUBLE_SHA1_PASSWORD") /*Underscore is intentional*/ \
    ...
    MR_MACROS(JOIN, "JOIN") \
    MR_MACROS(KERBEROS, "KERBEROS") /*Underscore is intentional*/ \
    ...
    MR_MACROS(LDAP, "LDAP") /*Underscore is intentional*/ \
    ...
    MR_MACROS(OVER, "OVER") \
    MR_MACROS(PART_MOVE_TO_SHARD, "PART_MOVE_TO_SHARD") /*Underscore is intentional*/ \
    ...
    MR_MACROS(PLAINTEXT_PASSWORD, "PLAINTEXT_PASSWORD") /*Underscore is intentional*/ \
    MR_MACROS(PLAN, "PLAN") \
    ...
    MR_MACROS(SET_ROLE, "SET_ROLE") \
    MR_MACROS(SET_TRANSACTION_SNAPSHOT, "SET TRANSACTION SNAPSHOT") \
    MR_MACROS(SET, "SET") \
    MR_MACROS(SETTINGS, "SETTINGS") \
    MR_MACROS(SHA256_HASH, "SHA256_HASH") /*Underscore is intentional*/ \
    MR_MACROS(SHA256_PASSWORD, "SHA256_PASSWORD") /*Underscore is intentional*/ \
    ...
    MR_MACROS(SS, "SS") \
    MR_MACROS(SSL_CERTIFICATE, "SSL_CERTIFICATE") /*Underscore is intentional*/ \
    MR_MACROS(STEP, "STEP") \
...
private:
    ...
    ParserKeyword(std::string_view s_): s(s_) { assert(!s.empty()); }
